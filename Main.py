...
# Retrieve documents from collection for a set of queries using tf-idf search.
# Rerank tf-idf search results with LLM.
...
def main(answers_filepath, topics_1_filepath, topics_2_filepath):
    ...
    print("Base results for topic 1 complete.")
    topics2 = BaseSearch.load_json_file(topics_2_filepath)
    print("Base results for topic 2 complete.")
    ...
    print(f"Reranked search results for topics 1 saved to {prompt1_1_output} and {prompt2_1_output}")
    ...
    print(f"Reranked search results for topics 2 saved to {prompt1_2_output} and {prompt2_2_output}")
